...
def send(data_buffer: io.BytesIO, attachments_dir: str = None):
    """
    ...
    # This is binary data: image PNG
    # It was not loaded from attachments, but generated by make_plot() function
    graph3_embedded = MIMEImage(data_buffer.getvalue(), subtype='png')
